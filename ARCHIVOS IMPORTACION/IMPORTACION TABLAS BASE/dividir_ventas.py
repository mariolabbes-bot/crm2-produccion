...
output_prefix = 'carga_ventas_parte'
...
for i in range(num_files):
    ...
    with open(output_file, 'w', encoding='utf-8') as outfile:
        # Escribir header
        outfile.write(f"-- Script de carga de VENTAS - PARTE {i+1} de {num_files}\n")
        ...
        if i == num_files - 1:
            ...
            outfile.write(f"SELECT COUNT(*) as registros_cargados FROM venta;\n")
