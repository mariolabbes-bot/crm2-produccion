...
const dataRaw = fs.readFileSync(path.join(__dirname, '../outputs/final_audit.json'), 'utf8');
const data = JSON.parse(dataRaw);

const users = data.audit.users;
const aliases = data.audit.aliases;
const ventas = data.audit.ventas_3_meses;
const abonos = data.audit.abonos_3_meses;
...
fs.writeFileSync(path.join(__dirname, '../outputs/FINAL_VERIFICATION_REPORT.md'), report);
console.log('Report generated at outputs/FINAL_VERIFICATION_REPORT.md');
