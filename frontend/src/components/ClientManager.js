...
import {
    Box, AppBar, Toolbar, Typography, Button, IconButton, Container,
    List, ListItem, ListItemText, Alert, TextField, Link
} from '@mui/material';
...
const ClientManager = () => {
    ...
    const [nuevoCliente, setNuevoCliente] = useState({
        rut: '', nombre: '', direccion: '', ciudad: '', estado: '',
    ...
    const handleAddClient = async (e) => {
        ...
        try {
            ...
            setNuevoCliente({
                rut: '', nombre: '', direccion: '', ciudad: '', estado: '',
                codigo_postal: '', pais: '', telefono: '', email: '', vendedor_id: ''
            });
            fetchClients();
        } catch (err) {
            console.error(err);
