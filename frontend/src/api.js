...
export const patchClientCoordinates = (rut, latitud, longitud) =>
  apiFetch(`${API_URL}/clients/${rut}/coordinates`, {
    method: 'PATCH',
...
export const getEvolucionYoy = (params = {}) => {
  const qs = new URLSearchParams(params).toString();
...
export const submitVisitPlan = (clientes, data = {}) => {
  const payload = { clientes };
  if (typeof data === 'string') {
    payload.fecha = data;
  } else {
    Object.assign(payload, data);
  }
  return apiFetch(`${API_URL}/visits/plan`, {
    method: 'POST',
...
export const deleteVisit = (id) => apiFetch(`${API_URL}/visits/${id}`, { method: 'DELETE' });
